...
<!-- Assegna punti a inizio partita -->
  ...
  function assegnapunti(points) {
    ...
    document.getElementById("punti6").innerHTML = points;
...
<!-- Sottrae punti quando si preme pulsante -->
  ...
  function puntip6() {
    ...
    if ((punti == "0") || (punti == "L")) {
      console.log(punti);
      document.getElementById("punti6").style.color = "red";
      document.getElementById("punti6").innerHTML = "L";
    } else {
    punti--;
      document.getElementById("punti6").innerHTML = punti;
    }
    }
...
<!-- Nuova partita, riassegna i punti e segna le vittorie -->
  ...
  function newgame() {
          ...
          document.getElementById("punti6").innerHTML = 6;
          document.getElementById("punti6").style.color = "white";
        }
